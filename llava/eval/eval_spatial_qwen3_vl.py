...
# Evaluation script for Qwen3-VL models on SpatialRGPT-Bench
# Based on official Qwen3-VL usage: https://huggingface.co/Qwen/Qwen3-VL-4B-Instruct
...
def eval_model(args):
    """Evaluate Qwen3-VL model on SpatialRGPT-Bench with batch evaluation."""
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(
        description="Evaluate Qwen3-VL models on SpatialRGPT-Bench"
    )
    ...
    parser.add_argument(
        ...
        help="HuggingFace model name or path (default: Qwen/Qwen3-VL-4B-Instruct)"
    )
    parser.add_argument(
        "--cache-dir",
        type=str,
