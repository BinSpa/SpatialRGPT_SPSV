# Evaluation script for Gemma-3-4b-it models on SpatialRGPT-Bench
# Based on official Gemma-3 usage: https://huggingface.co/google/gemma-3-4b-it
...
def eval_model(args):
    """Evaluate Gemma-3 model on SpatialRGPT-Bench."""
    ...
    for batch_idx in tqdm(range(total_batches), desc="Evaluating batches"):
        ...
        for line in batch_questions:
            ...
            # Build messages — Gemma-3 merges system prompt into user message
            messages = [
                {
                    "role": "user",
                    "content": [
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(
        description="Evaluate Gemma-3 models on SpatialRGPT-Bench"
    )
