# Evaluation script for Molmo2-4B models on SpatialRGPT-Bench
# Based on official Molmo usage: https://huggingface.co/allenai/Molmo2-4B
...
def eval_model(args):
    """Evaluate Molmo2-4B model on SpatialRGPT-Bench."""
    ...
    for batch_idx in tqdm(range(total_batches), desc="Evaluating batches"):
        ...
        for line in batch_questions:
            ...
            # Build messages using Molmo2 chat template format
            # Molmo2 doesn't support system role, so prepend to user text
            messages = [
                {"role": "user", "content": [
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(
        description="Evaluate Molmo2-4B models on SpatialRGPT-Bench"
    )

    parser.add_argument("--model-path", type=str, default="allenai/Molmo2-4B",
